...
public class sketch_jan06a extends PApplet {
...
public void mouseClicked(){
  if(circles.size() < 3){
   ...
   if(circles.size() == 3){
    ...
    a.radius = 0.5f*(-dist(c.center.x,c.center.y,b.center.x,b.center.y)+dist(c.center.x,c.center.y,a.center.x,a.center.y)+dist(b.center.x,b.center.y,a.center.x,a.center.y));
    b.radius = 0.5f*(dist(c.center.x,c.center.y,b.center.x,b.center.y)-dist(c.center.x,c.center.y,a.center.x,a.center.y)+dist(b.center.x,b.center.y,a.center.x,a.center.y));
    c.radius = 0.5f*(dist(c.center.x,c.center.y,b.center.x,b.center.y)+dist(c.center.x,c.center.y,a.center.x,a.center.y)-dist(b.center.x,b.center.y,a.center.x,a.center.y)); 
...
public float determineRadius() {return 0.0f;}
...
public class Circle{
 ...
 public void display() {
  ...
  ellipse(center.x,center.y,radius*2.0f,radius*2.0f);
  fill(0);
  if(textOn && !outer && abs(round(1.0f/this.radius*((Circle)circles.get(3)).radius)) > 0) {
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#FFFFFF", "sketch_jan06a" });
  }
}
